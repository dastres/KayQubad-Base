    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at_jalali', django_jalali.db.models.jDateTimeField(auto_now=True, verbose_name='updated at')),
                ('title', models.CharField(max_length=350, verbose_name='title')),
                ('image', models.ImageField(upload_to='basic_gallery/images/2023/1', verbose_name='image')),
                ('image_alt', models.CharField(blank=True, max_length=350, verbose_name='image alt')),
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='portfolio_gallery', to='portfolio.portfolio')),
            ],
            options={
                'verbose_name': 'Portfolio',
                'verbose_name_plural': 'Portfolios',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_alt', models.CharField(blank=True, max_length=350, verbose_name='thumbnail alt')),
                ('status', models.CharField(choices=[('PU', 'Publish'), ('IN', 'Inriview'), ('PE', 'Pending')], default='PE', max_length=2, verbose_name='status')),
                ('sub_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='portfolio.portfoliocategory')),
                ('sub_category_en', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='portfolio.portfoliocategory')),
                ('sub_category_fa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='portfolio.portfoliocategory')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='portfolios', to='portfolio.portfoliocategory'),
        ),
        migrations.AddField(
            model_name='portfolio',
            name='category_en',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='portfolios', to='portfolio.portfoliocategory'),
        ),
        migrations.AddField(
            model_name='portfolio',
            name='category_fa',
